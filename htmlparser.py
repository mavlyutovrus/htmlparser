...
class HTMLTextBlocksTree(list):
    ...
    # actor should be an object with a method "act" declared as:
    ...
    def get_similar_sense_texts(self):
        ...
        text_elements = [(self.__get_node_depth(node_index), node_index) 
		          for node_index in text_elements]
